        ...
        if(choice == 1){
            ...
            if(gn1[0] != 'q'){
                ...
                if(games[index1] == games[index2]){
                    cout << games[index1].getName() << " has more marked cells than " << games[index2].getName() << endl << endl;
                }
                else{
                    cout << games[index2].getName() << " has either more marked cells than " << games[index1].getName() << " or has the same amount of marked cells" << endl;
                }
            }
        }
        else if(choice == 4){
