public class LinkedList<E> implements List<E>, Queue<E>{
    ...
    /**
     * Returns, but does not remove, the head of this list
     * @exception EmptyListException if the list is empty
     * @return head of this list
     */
    @Override
    public E element() throws EmptyListException{
    ...
    /**
     * Returns and removes the head of this list
     * @exception EmptyListException if the list is empty
     * @return head of this list
     */
    @SuppressWarnings("unchecked")
    @Override
    public E poll() throws EmptyListException{
        if(this.isEmpty()) throw new EmptyListException();
        E temporary = arr[0];
        temp = arr;
        arr = (E[]) new Object[temp.length - 1];
