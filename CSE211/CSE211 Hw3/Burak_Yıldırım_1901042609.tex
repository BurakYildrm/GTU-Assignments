...
\end{figure*}
\solution\newline
Columns start with a at the left side and go rightward to e alphabetical and rows start  with a at the upper side and go downward to e alphabetical. 1 indicates a directed path between vertices and 0 indicates no directed path between vertices.\newline
$$
\begin{bmatrix} 
    0 & 1 & 0 & 1 & 0\\
    1 & 0 & 1 & 1 & 1\\
...
There is no Hamilton circuit in this graph. If we use every edge just once there are mininum 3 vertices left.
\subproblem{b} \solution\\
This graph has 3 vertices of degree 1 so there can't be Hamilton circuit in this graph. These vertices are vertex e, vertex f and vertex g.
\subproblem{c} \solution\\
There is Hamilton circuit in this graph. adgheifcba is a Hamilton circuit.
\newpage
...
\newline
\solution\newline
We need minimum 5 different time slots.\newline
\begin{center}
    \includegraphics[width = .6\textwidth]{Graph Coloring.png}
\end{center}
\newpage
