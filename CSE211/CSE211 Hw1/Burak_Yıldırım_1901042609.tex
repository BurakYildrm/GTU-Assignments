...
\solution
\newline
(P(x) $\wedge$ Q(x)) $\Longrightarrow$ H(x).
...
\newline
for n = 1;\newline
3 + 3.5 = $\frac{3(5^{1+1} - 1)}{4}$ \qquad 18 = $\frac{3.24}{4}$ \qquad  18 = 18 \newline   
for n = k;\newline
3 + 3 . 5 + 3 . $5^2$ + . . . + 3 . $5^k$ = $\frac{3(5^{k+1} - 1)}{4}$ \newline
for n = k + 1;\newline
3 + 3 . 5 + 3 . $5^2$ + . . . + 3 . $5^k$ + 3.$5^{k + 1}$ = $\frac{3(5^{k+2} - 1)}{4}$\newline\newline
$\frac{3(5^{k+1} - 1)}{4}$ + 3.$5^{k + 1}$ = $\frac{3(5^{k+2} - 1)}{4}$ \qquad $\frac{15.5^{k+1} - 3}{4}$ = $\frac{3.5^{k+2} - 3}{4}$ \newline\newline 75.$5^k$ - 3 = 75.$5^k$ - 3 \newline
\problem{5: Mathematical Induction}{20}
Prove that $n^2$ - 1 is divisible by 8 whenever n is an odd
positive integer.
\solution\newline
n = 2k + 1 \qquad $n^2$ - 1 = 4$k^2$ + 4k\newline
for k = 1;\newline4($1^2$) + 4.1 = 8 is divisible by 8.\newline
for k = 2;\newline4($2^2$) + 4.2 = 24 is divisible by 8.\newline
n = 2k \qquad $n^2$ - 1 = 4$k^2$ - 1\newline
for k = 1;\newline4($1^2$) - 1 = 3 is not divisible by 8.\newline
for k = 2;\newline4($2^2$) - 1 = 15 is not divisible by 8.\newline
This indicates that  4$k^2$ + 4k is divisible by 8 for all positive iterations of k and 4$k^2$ - 1 is not divisible by 8 for all positive iterations of k so $n^2$ - 1 is divisible by 8 whenever n is an odd positive integers
\problem{6: Sets}{8}
...
\solution
\newline
(a) $\Delta$ = $6^2$ - 4.8.1 = 4. \qquad $x_1$ = $\frac{6 + \sqrt{4}}{2.1}$ = 4. \qquad $x_2$ = $\frac{6 - \sqrt{4}}{2.1}$ = 2.\qquad a = $\{$2, 4$\}$\newline\newline
(b) b has infinite number of elements because there is infinite number of real numbers between 2 and 3.\newline\newline
(c) $\{$4, 2, 5, 4$\}$ \newline\newline
(d) $\{$4, 2$\}$\newline\newline
(e) e = $\{$4, 2$\}$ because rectangle has 4 sides and any integer between 11 and 99 has 2 digits.\newline\newline
a, d and e have the same elements so a = d = e.
\newpage
