...
\solution No because $\{$1, 3, 4$\}$ and $\{$2, 3, 4$\}$ are not comparable.
\subproblem{d} Find all upper bounds of $\{\{$2$\}$, $\{$4$\}\}$.
\solution $\{\{$2, 4$\}$, $\{$2, 3, 4$\}\}$
\subproblem{e} Find the least upper bound of $\{\{$2$\}$, $\{$4$\}\}$, if it exists.
\solution It doesn't exist because $\{$2$\}$ and $\{$4$\}$ are not comparable and they are at the same level.
\subproblem{f} Find all lower bounds of $\{\{$1, 3, 4$\}$, $\{$2, 3, 4$\}\}$.
\solution $\{\{$3, 4$\}$, $\{$4$\}\}$
\subproblem{h} Find the greatest lower bound of $\{\{$1, 3, 4$\}$, $\{$2, 3, 4$\}\}$,
if it exists.
\solution It doesn't exist because $\{$1, 3, 4$\}$ and $\{$2, 3, 4$\}$ are not comparable and they are at the same level.\newline
\begin{center}
    \includegraphics[width = .5\textwidth]{problem2.png}
\end{center}
\newpage
